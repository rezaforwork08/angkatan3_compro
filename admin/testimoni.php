...
$queryTestimoni = mysqli_query($koneksi, "SELECT * FROM testimoni WHERE deleted_at IS NULL");
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php $no = 1;
                                                $rowTestimonies = mysqli_fetch_all($queryTestimoni, MYSQLI_ASSOC);
                                                foreach ($rowTestimonies as $rowTestimoni) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $rowTestimoni['nama'] ?></td>
                                                        <td><?php echo $rowTestimoni['profesi'] ?></td>
                                                        <td><?php echo $rowTestimoni['deskripsi'] ?></td>
                                                        <td><img src="upload/<?php echo $rowTestimoni['foto'] ?>" width="115" alt=""></td>
                                                        <td>
                                                            <a href="tambah-testimoni.php?testimoniId=<?php echo $rowTestimoni['id'] ?>" class="btn btn-success btn-sm">
                                                                Edit
                                                            </a>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"
                                                                href="?delete=<?php echo $rowTestimoni['id'] ?>" class="btn btn-danger btn-sm">
